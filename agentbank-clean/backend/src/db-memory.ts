...
// ── Agents ─────────────────────────────────────────────────────────────────
export function createAgent(params: { operatorId: string; name: string; description: string; walletAddress: string; chain: string; policy: Policy; claimStatus?: "pending"|"claimed"; roleName?: string; roleDocument?: string; inGroup?: boolean; }): Agent {
  const agent: Agent = {
